...
function consoleTip() {
  ...
  console.log('源码已开源在（ https://github.com/yixiangxiao )，任何问题请提issue,喜欢请点个star吧！');
  console.log('如果您有什么建议或者想学习博客搭建，欢迎您加入我们,我们互相学习，共同进步^_^  %cQQ小群( https://jq.qq.com/?_wv=1027&k=58Ypj9z )', 'color:red');
}
